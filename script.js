const translations = {
  en: {
    ...
    trustOneTitle: "Remote-first collaboration",
    trustOneText: "Clear communication without studio visits.",
    trustTwoTitle: "Responsive design",
    trustTwoText: "Built for mobile, desktop and real customers.",
    trustThreeTitle: "Launch-ready delivery",
    ...
    showcaseIntro:
      "These are service directions and concept spaces for upcoming work, not fake client case studies.",
    ...
    homeWorkTitle: "Case studies will be added as new client projects launch.",
    homeWorkText:
      "Until then, this space is reserved for polished examples of business websites, web applications and UX/UI systems.",
    viewWork: "View work page",
    ...
    homeProcessTitle: "From idea to launch, with direct communication at every step.",
  ...
  nl: {
    ...
    deliveryValue: "Remote-first",
    trustOneTitle: "Remote-first samenwerking",
    trustOneText: "Heldere communicatie zonder studiobezoek.",
    trustTwoTitle: "Responsive design",
    trustTwoText: "Gebouwd voor mobiel, desktop en echte klanten.",
    trustThreeTitle: "Klaar voor lancering",
    ...
    showcaseIntro:
      "Dit zijn servicerichtingen en conceptruimtes voor toekomstig werk, geen verzonnen klantcases.",
    ...
    homeWorkTitle: "Cases worden toegevoegd wanneer nieuwe klantprojecten live gaan.",
    homeWorkText:
      "Tot die tijd is deze ruimte gereserveerd voor sterke voorbeelden van zakelijke websites, webapplicaties en UX/UI-systemen.",
    viewWork: "Bekijk werkpagina",
    ...
    homeProcessTitle: "Van idee tot lancering, met directe communicatie bij elke stap.",
